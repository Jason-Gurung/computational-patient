...
Preclinical development relies on animal models and in vitro assays. Animal models are expensive, slow, and often misleading — drugs that work in mice frequently fail in humans. The species gap is enormous and largely unbridgeable.

First-in-human dose selection is conservative by necessity — start very low, escalate slowly, because we don't actually know what will happen.
...
- **A large share of candidates killed before Phase I** — currently these fail in Phase I at much higher cost
- **Phase I entered with computationally optimised dosing** — escalation is faster because the starting dose is more informed
- **Significant cost savings per early kill**
- **Preclinical phase compresses dramatically**

## Phase I: Safety with Foresight

### What Happens Today

Phase I enrolls a small group of healthy volunteers to establish safety and pharmacokinetics. It's a cautious, stepwise dose escalation with limited information about what to expect.
...
- **Phase I compresses significantly**
...
- **Earlier identification of the recommended Phase II dose**

## Phase I → Phase II: The Critical Handoff

### What Happens Today

Phase II is where most drugs die — success rates are low. The transition from Phase I to Phase II is a leap of faith: "It was safe in healthy volunteers, let's see if it works in patients." Trial design is based on precedent and committee judgment.
...
- **Phase II success rate increases significantly** (better candidates enter, better trial designs detect real effects)
- **Phase II duration compresses substantially**
- **Trial sizes reduced meaningfully** (better patient selection, more sensitive endpoints)

## Phase II → Phase III: The Most Expensive Decision in Business

### What Happens Today

The Phase III go/no-go decision is the single most consequential decision in pharmaceutical development. Go: commit enormous capital and years. No-go: write off everything invested so far. Today, this decision is made by experienced people reviewing Phase II data, precedent, competitive landscape, and commercial forecasts. It's informed judgment — but a large proportion of Phase III trials still fail.
...
**Preventing even a handful of Phase III failures per decade saves enormous capital and frees years of organisational capacity.** This is where the computational patient pays for itself many times over.

### Impact

- **Phase III success rate increases substantially** (only high-probability programs advance, and they advance with optimised designs)
- **Phase III trial sizes reduced significantly** (better patient selection, better endpoints)
- **Phase III duration compresses dramatically** (faster enrolment through better site selection, better retention through shorter protocols)
...
Every phase compresses. The computational layer de-risks each transition, so phases can overlap more, start with better information, and run with smaller cohorts. The cumulative effect across the full pipeline is transformative — not an incremental improvement but a structural compression of the entire development process.
